...
public class TALLERCLASE {
  ...
  -   Adicionalmente y al final de la clase se ha incluido como ejemplo el metodo  public static String[] getDirecciones(String[] data). Ese metodo se usa para
    ...
    public static void main(String[] args) {
        ...
        data.add(new InformacionPersonal("Juan","Pérez",LocalDate.parse("15/03/1985", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123","Medellin","Licenciatura en Ingeniería","Ingeniero de Software",'M',70,1.75F));
        ...
        data.add(new InformacionPersonal("Martín","Torres",LocalDate.parse("30/02/1998", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6","Aldea","Bachiller","Estudiante",'M',68,1.78F));
        ...
        //2. Estaturas:
        float menosAlto = data.get(0).estatura;
        float masAlato = data.get(0).estatura;
        for(InformacionPersonal informacionPersonal : data) {
